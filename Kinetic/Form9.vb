Public Class Form9
    ...
    Public LayerCtrl(,) As Double
    Public CurrentLayer As Long = 0
    ...
    Sub ResetMap()
        ...
        ChangeSourcePosition(LayerCtrl(0, 1))
        t = 0
        CurrentLayer = 0
    End Sub
    ...
    Public Sub Button7_Click(sender As Object, e As EventArgs) Handles Button7.Click
        If OpenFileDialog1.ShowDialog = DialogResult.OK Then
            ...
            ReDim LayerCtrl(t.Length - 1, 1)
            For i As Long = 0 To t.Length - 1
                LayerCtrl(i, 0) = t(i).Split({","}, StringSplitOptions.RemoveEmptyEntries)(0)
                LayerCtrl(i, 1) = t(i).Split({","}, StringSplitOptions.RemoveEmptyEntries)(1)
            Next
            CurrentLayer = 0
        End If
    ...
    Public Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        For m As Long = 0 To NumericUpDown3.Value
            t += frm1.StepLength
            fps += 1
            If t > LayerCtrl(CurrentLayer, 0) Then
                CurrentLayer += 1
                If CurrentLayer > LayerCtrl.GetLength(0) - 1 Then
                    Timer1.Enabled = False
                    SaveFrm.SaveData()
                    CheckBox1.Checked = False
                    RefreshMap()
                    ...
                    Exit Sub
                End If
                ChangeSourcePosition(LayerCtrl(CurrentLayer, 1))
            End If
            CalcNextFrame()
            RenderFramCount += 1
    ...
    Public Sub Form9_Load(sender As Object, e As EventArgs) Handles Me.Load
        SaveFrm = New Form3
        SaveFrm.frm7 = Me
        SaveFrm.PForm = 7
